...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/api/assets/favicon.ico' },
      { url: '/api/assets/favicon-16x16.png', sizes: '16x16', type: 'image/png' },
      { url: '/api/assets/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
    ],
    shortcut: "/api/assets/icon.png",
    apple: "/api/assets/apple-touch-icon.png",
  },
  openGraph: {
    ...
    images: [
      {
        url: "https://webzono.com/api/assets/logo.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://webzono.com/api/assets/logo.png"],
    creator: "@webzono",
  },
  alternates: {
...
const jsonLd = {
  ...
  "name": "WEBZONO",
  "url": "https://webzono.com",
  "logo": "https://webzono.com/api/assets/logo.png",
  "contactPoint": {
    "@type": "ContactPoint",
